...
namespace Furnace\NHIField\Tests;

use SilverStripe\Dev\SapphireTest;
use Furnace\NHIField\Forms\LegacyNHIField;
use SilverStripe\Forms\RequiredFields;

/**
 * Test the NHI db field.
 */
class LegacyNHIFieldTest extends SapphireTest
{
    public function testValidNHI()
    {
        $field = LegacyNHIField::create('dummy');
    ...
    {
        LegacyNHIField::config()->disable_checksum_validation = true;
    ...
    {
        $field = LegacyNHIField::create('dummy', 'dummy', 'ept6335');
    ...
    public function testPattern()
    {
        ...
        $field = LegacyNHIField::create('dummy', 'dummy', 'ept6335', null, false);
        ...
        $field = LegacyNHIField::create('dummy', 'dummy', 'ept6335', null, true);
